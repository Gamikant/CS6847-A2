#!/usr/bin/env python3
"""
Plot performance experiments for Query 3
Generates plots for:
...
def plot_reducer_experiment(csv_file='reducer_experiment_results.csv', output_file='q3_reducers_plot.png'):
    ...
    plt.plot(df['num_reducers'], df['time_seconds'], 
             ...
             color='#6A4C93', markerfacecolor='#1982C4',
             markeredgewidth=2, markeredgecolor='#6A4C93')
    ...
    plt.title('Query 3: Execution Time vs Number of Reducers\n(Most Visited Locations - NYC Taxi 2013)', 
...
def plot_slowstart_experiment(csv_file='slowstart_experiment_results.csv', output_file='q3_slowstart_plot.png'):
    ...
    plt.plot(df['slowstart_fraction'], df['time_seconds'],
             ...
             color='#8338EC', markerfacecolor='#FFBE0B',
             markeredgewidth=2, markeredgecolor='#8338EC')
    ...
    plt.ylabel('Execution Time (seconds)', fontsize=14, fontweight='bold')
    plt.title('Query 3: Execution Time vs Slow Start Parameter\n(Most Visited Locations - NYC Taxi 2013)', 
              fontsize=16, fontweight='bold', pad=20)
    plt.grid(True, alpha=0.3, linestyle='--')
...
def print_summary(reducer_csv='reducer_experiment_results.csv', 
    ...
    print("\n" + "="*60)
    print("QUERY 3 EXPERIMENT SUMMARY")
    print("="*60)
...
if __name__ == "__main__":
    print("="*60)
    print("Query 3 Performance Analysis - Plot Generator")
    ...
    if success:
        ...
        print("\nGenerated files:")
        if reducer_exists:
            print("  - q3_reducers_plot.png")
        if slowstart_exists:
            print("  - q3_slowstart_plot.png")
    else:
