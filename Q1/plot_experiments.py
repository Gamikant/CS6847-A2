#!/usr/bin/env python3
"""
Plot performance experiments for Query 1
Generates plots for:
...
def plot_reducer_experiment(csv_file='reducer_experiment_results.csv', output_file='q1_reducers_plot.png'):
    ...
    plt.title('Query 1: Execution Time vs Number of Reducers\n(NYC Taxi 2013 Dataset)', 
...
def plot_slowstart_experiment(csv_file='slowstart_experiment_results.csv', output_file='q1_slowstart_plot.png'):
    ...
    plt.plot(df['slowstart_fraction'], df['time_seconds'],
             ...
             color='#06A77D', markerfacecolor='#F77F00',
             markeredgewidth=2, markeredgecolor='#06A77D')
    ...
    plt.ylabel('Execution Time (seconds)', fontsize=14, fontweight='bold')
    plt.title('Query 1: Execution Time vs Slow Start Parameter\n(NYC Taxi 2013 Dataset)', 
              fontsize=16, fontweight='bold', pad=20)
    plt.grid(True, alpha=0.3, linestyle='--')
...
if __name__ == "__main__":
    print("="*60)
    print("Query 1 Performance Analysis - Plot Generator")
    print("="*60)
    ...
    if success:
        ...
        print("\nGenerated files:")
        if reducer_exists:
            print("  - q1_reducers_plot.png")
        if slowstart_exists:
            print("  - q1_slowstart_plot.png")
    else:
